...
Title = Label(main, text = " PASSWORD GENERATOR",bg="powder blue",fg ="black",font=("futura",15,"bold"))
...
generate_btn = Button(main, text="Generate Password 🔐",bg ="orange",fg="black", font=("ubuntu", 15), cursor="hand2", command = password_generate)
generate_btn.bind("<Enter>", on_enter)
generate_btn.bind("<Leave>", on_leave)
generate_btn.place(x=120,y=140)

result_lable = Label(main, text = "Generated Password Here 🔑:- ", bg="beige", fg ="darkgreen",font=("ubuntu", 12))
result_lable.place( x=20, y= 200)

password = StringVar()
password_final = Entry(main, textvariable = password, state="readonly", fg="blue", font=("ubuntu",15),width=30)
